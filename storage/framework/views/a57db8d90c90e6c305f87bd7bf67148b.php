...
<body>
    <div class="container m-5">
        ...
        <h6 class="mt-4">pawpaw</h6>
        <div class="list-group list-group-numbered mt-4">
            <a href="<?php echo e(url('/pawpaw')); ?>" class="list-group-item list-group-item-action">
                pawpaw
            </a>
        </div>
...
<?php /**PATH C:\Users\ADMIN\Documents\Ayundha\LARAVEL\Praktikum1\resources\views/routing.blade.php ENDPATH**/ ?>